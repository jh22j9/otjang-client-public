...
export const clothing = List([
    Map({
        ...
        storage: null,
        season: Map({
            seasonArray: List(['spring', null, null, null]),
    ...
    Map({
        ...
        storage: null,
        season: Map({
            seasonArray: List([null, 'summer', null, null]),
...
export const shoes = List([
    ...
    Map({
        ...
        storage: null,
        season: Map({
            seasonArray: List([null, null, 'fall', null]),
    ...
    Map({
        ...
        storage: null,
        season: Map({
            seasonArray: List([null, null, null, 'winter']),
...
export const accessories = List([
    ...
    Map({
        ...
        storage: null,
        season: Map({
            seasonArray: List([null, 'summer', 'fall', null]),
